...
export default function RecommendationsPanel({
  ...
  if (loading) {
    return (
      <div className="w-80 bg-gray-800/50 backdrop-blur-xl border-l border-gray-700/30 p-4 flex items-center justify-center">
  ...
  if (error) {
    return (
      <div className="w-80 bg-gray-800/50 backdrop-blur-xl border-l border-gray-700/30 p-4">
  ...
  return (
    <div className="w-80 bg-gray-800/50 backdrop-blur-xl border-l border-gray-700/30 flex flex-col overflow-hidden">
      {/* Header */}
      <div className="p-4 border-b border-gray-700/30 bg-black/20">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
              ...
              {teamPrelocks.map((championId) => {
                ...
                return (
                  <div
                    ...
                    className="flex items-center gap-3 p-3 bg-blue-900/30 rounded-lg border border-blue-700/50 hover:bg-blue-900/50 transition-colors"
                  >
                    {/* Icon Badge */}
                    <div className="flex-shrink-0 w-8 h-8 flex items-center justify-center bg-gradient-to-br from-blue-500 to-blue-700 rounded-full text-white">
                    ...
                    {/* Champion Image */}
                    <div className="flex-shrink-0 w-12 h-12 rounded-lg overflow-hidden border-2 border-blue-600/50">
                      <img
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="text-xs text-blue-300">Teammate wants</div>
                    </div>
                  </div>
                );
              })}
        ...
        {recommendations && recommendations.recommendations.length > 0 && (
          <div>
            <div className="text-xs font-semibold text-purple-400 uppercase tracking-wider mb-2 px-1">
              AI Suggestions
            </div>
            <div className="space-y-2">
              {recommendations.recommendations.map((rec, idx) => {
                ...
                return (
                  <div
                    key={rec.champion_id}
                    className="flex items-center gap-3 p-3 bg-gray-900/50 rounded-lg border border-gray-700/30 hover:bg-gray-900/70 transition-colors"
                  >
                    {/* Rank Badge */}
                    <div className="flex-shrink-0 w-8 h-8 flex items-center justify-center bg-gradient-to-br from-purple-600 to-blue-600 rounded-full text-white font-bold text-sm">
                      {idx + 1}
                    </div>

                    {/* Champion Image */}
                    <div className="flex-shrink-0 w-12 h-12 rounded-lg overflow-hidden border-2 border-gray-700/50">
                      <img
